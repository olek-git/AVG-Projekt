...
public class ErpServiceImpl extends ErpServiceGrpc.ErpServiceImplBase {
    ...
    // Beispiel: public void getProduct(GetProductRequest request, StreamObserver<GetProductResponse> responseObserver) {
    ...
    public void processOrder(OrderRequest request, StreamObserver<OrderAck> responseObserver) {
        ...
        //TODO: Hier die Logik für Lieferdatum und -status implementieren, die direkt synchron ans ERP-System gesendet werden.
